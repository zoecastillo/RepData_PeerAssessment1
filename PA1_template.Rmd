...
The **mean** number of steps per day is **`r meansteps`** and the **median** number
...
**Interval `r maxinterval`** contains the **maximum number of steps** averaged across all days. It appears that the subject is most active in the morning hours.
...
There are **`r numofna`** missing values in the dataset. 
